...
FILESYSTEM_NAME_CEPH = 'ceph'
FILESYSTEM_NAME_CEPH_DRBD = 'ceph-float'
...
FILESYSTEM_LV_DICT = {
    ...
    FILESYSTEM_NAME_CEPH: 'ceph-lv',
    FILESYSTEM_NAME_CEPH_DRBD: 'ceph-float-lv',
}
...
FILESYSTEM_DRBD_DICT = {
    ...
    FILESYSTEM_NAME_CEPH_DRBD: DRBD_CEPH,
}

HOSTFS_CREATION_ALLOWED = [
...
CEPH_ROOK_BACKEND_FAILURE_DOMAIN_CAP = 'failure_domain'

# Ceph-rook failure domain values
CEPH_ROOK_CLUSTER_OSD_FAIL_DOMAIN = 'osd'
CEPH_ROOK_CLUSTER_HOST_FAIL_DOMAIN = 'host'

CEPH_ROOK_FAILURE_DOMAINS_SUPPORTED = [CEPH_ROOK_CLUSTER_OSD_FAIL_DOMAIN,
                                       CEPH_ROOK_CLUSTER_HOST_FAIL_DOMAIN]

CEPH_ROOK_BACKEND_CAP_DEFAULT = {
    CEPH_ROOK_BACKEND_DEPLOYMENT_CAP: CEPH_ROOK_DEPLOYMENT_CONTROLLER,
    CEPH_ROOK_BACKEND_FAILURE_DOMAIN_CAP: CEPH_ROOK_CLUSTER_HOST_FAIL_DOMAIN,
    CEPH_BACKEND_REPLICATION_CAP: CEPH_BACKEND_CAP_DEFAULT[CEPH_BACKEND_REPLICATION_CAP],
    CEPH_BACKEND_MIN_REPLICATION_CAP: CEPH_BACKEND_CAP_DEFAULT[CEPH_BACKEND_MIN_REPLICATION_CAP]
}
...
SERVICE_PARAM_SECTION_IDENTITY_LDAP_LINUX = 'ldap-linux'
SERVICE_PARAM_NAME_IDENTITY_LDAP_LOCKOUT_DURATION = \
    'lockout_seconds'
SERVICE_PARAM_NAME_IDENTITY_LDAP_LOCKOUT_FAILURE_ATTEMPTS = \
    'lockout_retries'
SERVICE_PARAM_NAME_IDENTITY_LDAP_LOCKOUT_DURATION_DEFAULT = 900
SERVICE_PARAM_NAME_IDENTITY_LDAP_LOCKOUT_FAILURE_ATTEMPTS_DEFAULT = 5

SERVICE_PARAM_NAME_IDENTITY_LDAP_INACTIVE_SESSION_TERM_TIMEOUT = \
    'inactive_session_term_timeout_seconds'
SERVICE_PARAM_NAME_IDENTITY_LDAP_INACTIVE_SESSION_TERM_TIMEOUT_DEFAULT = 900
...
SERVICE_PARAM_NAME_PLATFORM_TLS_MIN_VERSION = 'tls-min-version'
SERVICE_PARAM_NAME_PLATFORM_TLS_CIPHER_SUITE = 'tls-cipher-suite'

# TLS Version Values
SERVICE_PARAM_PLATFORM_TLS_VERSION_TLS12 = 'VersionTLS12'
SERVICE_PARAM_PLATFORM_TLS_VERSION_TLS13 = 'VersionTLS13'
SERVICE_PARAM_PLATFORM_TLS_VERSIONS = [
    SERVICE_PARAM_PLATFORM_TLS_VERSION_TLS12,
    SERVICE_PARAM_PLATFORM_TLS_VERSION_TLS13,
]

# Default TLS Configuration
SERVICE_PARAM_PLATFORM_TLS_MIN_VERSION_DEFAULT = SERVICE_PARAM_PLATFORM_TLS_VERSION_TLS12

# Valid TLS Cipher Suites (IANA naming)
SERVICE_PARAM_PLATFORM_TLS_CIPHERS_VALID = [
    # TLS 1.2 Ciphers
...
SERVICE_PARAM_PLATFORM_TLS_CIPHER_SUITE_DEFAULT = ','.join(
    SERVICE_PARAM_PLATFORM_TLS_CIPHERS_VALID
)
...
SERVICE_PARAM_PLATFORM_DRBD_HMAC_SHA1 = 'sha1'
SERVICE_PARAM_PLATFORM_DRBD_HMAC_SHA256 = 'sha256'
...
SERVICE_PARAM_NAME_SECURITY_COMPLIANCE_PASSWORD_EXPIRES_DAYS = 'password_expires_days'
SERVICE_PARAM_NAME_SECURITY_COMPLIANCE_INACTIVE_SESSION_TERM_TIMEOUT = 'inactive_session_term_timeout_seconds'
SERVICE_PARAM_NAME_SECURITY_COMPLIANCE_INACTIVE_SESSION_TERM_TIMEOUT_DEFAULT = 3000
...
OPENLDAP_CERT_FILE = "/etc/ldap/certs/openldap-cert.crt"
...
FLUXCD_CRD_HELM_REL_VERSION = 'v2'
...
APP_METADATA_DEPENDENT_APPS_ACTION_WARN = 'warn'
APP_METADATA_DEPENDENT_APPS_ACTION_IGNORE = 'ignore'
APP_METADATA_DEPENDENT_APPS_ACTION_ERROR = 'error'
APP_METADATA_DEPENDENT_APPS_ACTION_APPLY = 'apply'
APP_METADATA_DEPENDENT_APPS_ACTION_TYPES = [
    APP_METADATA_DEPENDENT_APPS_ACTION_WARN,
    APP_METADATA_DEPENDENT_APPS_ACTION_IGNORE,
    APP_METADATA_DEPENDENT_APPS_ACTION_ERROR,
    APP_METADATA_DEPENDENT_APPS_ACTION_APPLY
]
APP_METADATA_CLASS = 'class'
APP_METADATA_CLASS_CRITICAL = 'critical'
APP_METADATA_CLASS_STORAGE = 'storage'
APP_METADATA_CLASS_DISCOVERY = 'discovery'
APP_METADATA_CLASS_OPTIONAL = 'optional'
APP_METADATA_CLASS_REPORTING = 'reporting'
APP_METADATA_CLASS_TYPES = [
    APP_METADATA_CLASS_CRITICAL,
    APP_METADATA_CLASS_STORAGE,
    APP_METADATA_CLASS_DISCOVERY,
    APP_METADATA_CLASS_OPTIONAL,
    APP_METADATA_CLASS_REPORTING
]
...
APP_EVALUATE_REAPPLY_TYPE_ON_DEMAND_REAPPLY = 'on-demand-reapply'
...
APP_EVALUATE_REAPPLY_TRIGGER_TO_METADATA_MAP = {
    ...
    APP_EVALUATE_REAPPLY_TYPE_USM_UPGRADE_COMPLETE:
        APP_EVALUATE_REAPPLY_TYPE_USM_UPGRADE_COMPLETE,
    APP_EVALUATE_REAPPLY_TYPE_ON_DEMAND_REAPPLY:
        APP_EVALUATE_REAPPLY_TYPE_ON_DEMAND_REAPPLY
}

# Helm override update flags:
HELM_OVERRIDE_UPDATE_WITH_REAPPLY = 'reapply'
HELM_OVERRIDE_UPDATE_WITH_REAPPLY_ALL = 'reapply_all'
...
CERT_REQUEST_RESOURCE = 'certificaterequests.cert-manager.io'
CERT_GROUP_CERT_MANAGER = 'cert-manager.io'
...
CERT_LOCATION_MAP = {
    ...
    CERT_MODE_OPENLDAP: OPENLDAP_CERT_FILE,
...
DEPLOY_STATE_TRANSIENT_STATES = [
    DEPLOY_STATE_START,
    DEPLOY_STATE_ACTIVATE,
    DEPLOY_STATE_ACTIVATE_ROLLBACK,
]
...
DEPLOY_HOST_PENDING_STATES = [
    DEPLOY_HOST_PENDING,
    DEPLOY_HOST_ROLLBACK_PENDING,
]
