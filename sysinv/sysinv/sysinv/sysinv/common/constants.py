...
CERT_ALARM_ANNOTATION_ALARM = 'alarm'
CERT_ALARM_ANNOTATION_ALARM_BEFORE = 'alarm-before'
CERT_ALARM_ANNOTATION_ALARM_SEVERITY = 'alarm-severity'
CERT_ALARM_ANNOTATION_ALARM_TEXT = 'alarm-text'
