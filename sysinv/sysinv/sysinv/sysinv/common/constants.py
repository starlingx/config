...
SERVICE_PARAM_PLATFORM_KSOFTIRQD_PRIO_MIN = 1
SERVICE_PARAM_PLATFORM_KSOFTIRQD_PRIO_MAX = 99
# Kernel IRQ WORK
SERVICE_PARAM_PLATFORM_IRQ_WORK_PRIO = 'irq_work_priority'
SERVICE_PARAM_PLATFORM_IRQ_WORK_PRIO_MIN = 1
SERVICE_PARAM_PLATFORM_IRQ_WORK_PRIO_MAX = 99
# Kernel RCU Tree
SERVICE_PARAM_PLATFORM_KTHREAD_PRIO = 'kthread_prio'
SERVICE_PARAM_PLATFORM_KTHREAD_PRIO_MIN = 1
SERVICE_PARAM_PLATFORM_KTHREAD_PRIO_MAX = 99
...
APP_METADATA_CLASS_ORDERED_DICT = {
    APP_METADATA_CLASS_CRITICAL: [],
    APP_METADATA_CLASS_STORAGE: [],
    APP_METADATA_CLASS_DISCOVERY: [],
    APP_METADATA_CLASS_OPTIONAL: [],
