...
KUBE_HOST_UPGRADING_ETCD = 'upgrading-etcd'
KUBE_HOST_UPGRADED_ETCD = 'upgraded-etcd'
KUBE_HOST_UPGRADING_ETCD_FAILED = 'upgrading-etcd-failed'
...
class KubeOperator(object):
    ...
    def _get_kubernetesclient_storage(self):
        if not self._kube_client_storage:
            self._load_kube_config()
            self._kube_client_storage = client.StorageV1Api()
        return self._kube_client_storage
