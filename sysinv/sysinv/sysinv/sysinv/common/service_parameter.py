...
IDENTITY_LDAP_LOCKOUT_PARAMETER_OPTIONAL = [
...
IDENTITY_LDAP_LOCKOUT_PARAMETER_RESOURCE = {
    constants.SERVICE_PARAM_NAME_IDENTITY_LDAP_LOCKOUT_DURATION:
        'platform::faillock::params::suspended_timeout',
    constants.SERVICE_PARAM_NAME_IDENTITY_LDAP_LOCKOUT_FAILURE_ATTEMPTS:
        'platform::faillock::params::failed_login_attempts',
    constants.SERVICE_PARAM_NAME_IDENTITY_LDAP_INACTIVE_SESSION_TERM_TIMEOUT:
        'platform::customsh::params::tmout',
}
...
PLATFORM_KEYSTONE_PARAMETER_RESOURCE = {
    ...
    constants.SERVICE_PARAM_NAME_SECURITY_COMPLIANCE_PASSWORD_EXPIRES_DAYS:
        'keystone::security_compliance::password_expires_days',
    constants.SERVICE_PARAM_NAME_SECURITY_COMPLIANCE_INACTIVE_SESSION_TERM_TIMEOUT:
        'openstack::horizon::params::session_timeout',
}
...
KUBERNETES_KUBELET_PARAMETER_READONLY = [
    constants.SERVICE_PARAM_NAME_KUBELET_CGROUP_DRIVER,
    constants.SERVICE_PARAM_NAME_KUBELET_CGROUP_ROOT,
]
...
SERVICE_PARAMETER_SCHEMA = {
    constants.SERVICE_TYPE_IDENTITY: {
        ...
        constants.SERVICE_PARAM_SECTION_IDENTITY_LDAP_LINUX: {
            SERVICE_PARAM_OPTIONAL: IDENTITY_LDAP_LOCKOUT_PARAMETER_OPTIONAL,
            SERVICE_PARAM_VALIDATOR: IDENTITY_LDAP_LOCKOUT_PARAMETER_VALIDATOR,
            SERVICE_PARAM_RESOURCE: IDENTITY_LDAP_LOCKOUT_PARAMETER_RESOURCE,
        },
    },
    constants.SERVICE_TYPE_PLATFORM: {
    ...
    constants.SERVICE_TYPE_KUBERNETES: {
        ...
        constants.SERVICE_PARAM_SECTION_KUBERNETES_KUBELET: {
            ...
            SERVICE_PARAM_READONLY: KUBERNETES_KUBELET_PARAMETER_READONLY,
        },
